...
public class RotateSquare {
	...
	public static void putSizeOfSquare() {
		...
		while (true) {
			/*
			 * if user put data isn't correct, inform user must put data again
			 */
			try {
				System.out.println("Please put size of square: ");
				...
				System.out.println("You put size of square not correct!");
			}
		}
	}
	...
	public static void putNumberOfCommands() {
		while (true) {
			...
			try {
				...
				System.out.println("You put number of commands not correct!");
			}
		}
		...
		System.out.println("Please put coordinates: ");
		...
		while (countNumberOfCommands < numberOfCommands) {
			...
			try {
				...
				/*
				 * Check constraint when user puted data of less two sub-square
				 */
				...
				System.out.println("You put coordinates not correct please put again: ");
			}
	...
	public static void putNumberOfQueries() {
		while (true) {
			...
			try {
				...
				System.out.println("Please put number of queries: ");
				numberOfQueries = Integer.parseInt(putData.nextLine());
				checkDataLimit(numberOfQueries, 10, 5);
				break;
			} catch (NumberFormatException | DataInvalidException e) {
				System.out.println("You put number of queries not correct!");
			}
		}
		...
		System.out.println("Please put values need to find: ");
		while (countNumberOfValues < numberOfQueries) {
			...
			try {
				...
				System.out.println("You put values need to find not correct please put again!");
			}
	...
	public static class DataInvalidException extends Exception {
		...
		/*When user put data of sub-square incorrect with constraints exception will occur*/
